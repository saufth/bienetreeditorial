        ...
        <div className='container pt-spacing-9'>
          <div className='max-w-5xl mx-auto'>
            ...
            <div className='[&_h2]:f-heading-2 [&_h2]:mt-spacing-7 [&_h2]:pb-spacing-4 [&_p]:f-subhead-2 [&_p]:text-muted-foreground [&_p]:text-balance [&_p]:mt-spacing-4'>
              ...
              <p>
                <b>{siteConfig.name}</b> no asume la responsabilidad en caso
              ...
              <p>
                ...
                cual podría incluir la verificación del stock y disponibilidad de producto,
              ...
              <p>
                Los precios de los productos ofrecidos en esta Tienda Online es válido solamente
              ...
              <p>
                <b>{siteConfig.name}</b>, a través de su sitio web, concede una licencia para que los
                usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los
              ...
              <p>
                En caso de que aplique (para venta de software, templetes, u otro producto de diseño
              ...
              <p>
                ...
                nuestros productos, modificado o sin modificar.
              </p>
              <p>
              ...
              <p>
                ...
                sin ningún tipo de garantía, expresa o implícita. En ningún momento esta compañía
                será responsable de ningún daño incluyendo, pero no limitado a, daños directos,
              ...
              <p>
                ...
                reembolsos después de que se envíe el producto, usted tiene la responsabilidad
                de entender antes de comprarlo.
              </p>
              <p>
                Le pedimos que lea cuidadosamente antes de comprarlo. Hacemos solamente
                excepciones con esta regla cuando la descripción no se ajusta al producto.
              </p>
              <p>
                Hay algunos productos que pudieran tener garantía y posibilidad de reembolso
                pero este será especificado al comprar el producto. En tales casos la garantía
                solo cubrirá fallas de fábrica y sólo se hará efectiva cuando el producto
              ...
              <p>
                <b>{siteConfig.name}</b> garantiza que la información personal
              ...
              <p>
                <b>{siteConfig.name}</b> reserva los derechos de cambiar
                o de modificar estos términos sin previo aviso.
              </p>
            </div>
          </div>
        </div>
