      ...
      <section>
        <div className='container py-spacing-7'>
          ...
          <div className='[&_h2]:f-heading-2 [&_h2]:mt-spacing-7 [&_h2]:pb-spacing-4 [&_p]:f-subhead-2 [&_p]:text-muted-foreground [&_p]:text-balance [&_p]:mt-spacing-4'>
            <p>
              Este sitio web es proporcionado por -{siteConfig.name}-. Tomamos con mucha seriedad
            ...
            <p>
              -{siteConfig.name}- únicamente recopilará información de identificación personal,
              como su nombre  o dirección de correo electrónico, cuando ella sea enviada
              voluntariamente a este sitio web. -{siteConfig.name}- y las empresas que contratamos
            ...
            <p>
              Este sitio web no está destinado ni diseñado para atraer a niños menores de 18 años. No recolectamos
            ...
            <p>
              -{siteConfig.name}- realiza esfuerzos razonables para que la Información personal
            ...
            <ul className='[&>li]:mt-spacing-4 list-disc pl-6'>
              ...
              <li>
                <p>
                  ...
                  de -{siteConfig.name}- o sus clientes.
                </p>
              </li>
            </ul>
            <p>
            ...
            <p>
              -{siteConfig.name}-, <Link href={address.url}>{address.name}</Link> O
              al correo: <Link href={`mailto:${contactEmail}`}>{contactEmail}</Link>
            </p>
            <p>
              -{siteConfig.name}- se compromete a trabajar con las personas para obtener una
              resolución justa de toda queja o disputa sobre la privacidad y la información personal. El compromiso
              de -{siteConfig.name}- con la privacidad queda demostrado y documentado
